...
def fasttext_wrapper(train_file_path, test_file_path, param_dict, fasttext_path, probability_file_prefix, thread=1):
    """
    ...
    :param param_dict: dictionary mapping hyperparameters to their values
    ...
    :return pair of str - fastText calls for training and testing
    """
    ...
    predict_call = fasttext_path + ' predict-prob model.bin ' + test_file_path + ' 2 | gzip > ' + prob_file_path
